    ...
    <div class="max-w-5xl mx-auto w-full space-y-6 sm:space-y-8 relative z-10">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#24242A]">
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#FF634A] to-[#FF8573] flex items-center justify-center text-[#09090B] shadow-lg shadow-[#FF634A]/25 border border-white/20">
            <Sparkles class="w-5 h-5 stroke-[2.2]" />
          </div>
          <div>
            <div class="flex items-center gap-1.5">
              <span class="text-base font-outfit-800 tracking-wider text-white">MOVA</span>
              <span class="text-[10px] font-mono px-1.5 py-0.5 rounded bg-[#FF634A]/20 text-[#FF634A] border border-[#FF634A]/30">SETUP</span>
            </div>
            <p class="text-xs text-zinc-400">Inisialisasi Fondasi Operasional Sistem</p>
          </div>
        </div>

        <div class="flex items-center gap-2">
          <span class="text-xs text-zinc-400">Langkah:</span>
          <span class="font-outfit-700 font-mono text-sm text-[#FF634A]">{setupStore.currentStep}</span>
          <span class="text-xs text-zinc-500">dari</span>
