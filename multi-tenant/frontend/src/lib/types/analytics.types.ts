/*
 * analytics.types.ts
 * S7-03-10: Frontend Historical Operational Analytics DTO Models
 * Exact Mirror of OpenAPI v4.1.0 & Frozen Backend Domain Read Models
 * 
 * Strict Invariants:
...
export interface HistoricalPresenceQuery {
  rangeStart: string;
  rangeEnd: string;
  timezone?: string;
  grain?: AnalyticsGrain;
...
export interface HistoricalDeviationsQuery {
  rangeStart: string;
  rangeEnd: string;
  timezone?: string;
  grain?: AnalyticsGrain;
...
export interface HistoricalZonesQuery {
  rangeStart: string;
  rangeEnd: string;
  timezone?: string;
  grain?: AnalyticsGrain;
...
export interface HistoricalRidersQuery {
  rangeStart: string;
  rangeEnd: string;
  timezone?: string;
  grain?: AnalyticsGrain;
...
export interface HistoricalComparisonQuery {
