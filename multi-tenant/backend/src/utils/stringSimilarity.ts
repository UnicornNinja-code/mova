/*
 * stringSimilarity.ts
 * Deterministic string normalization & similarity scoring engine for POI deduplication in TypeScript
 */

export function normalizePoiName(str: string = ""): string {
...
export function tokenSetSimilarity(norm1: string, norm2: string): number {
...
export function calculateStringSimilarity(name1: string = "", name2: string = ""): number {
