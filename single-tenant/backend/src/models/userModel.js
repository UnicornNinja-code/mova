...
export const UserModel = {
  ...
  updateRole: (id, newRole, client = null) => userRepository.updateUserRole(id, newRole, client),
  incrementAuthVersion: (id, client = null) => userRepository.incrementAuthVersion(id, client),
